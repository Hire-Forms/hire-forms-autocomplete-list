...
var AutocompleteList = function (_React$Component) {
	...
	_createClass(AutocompleteList, [{
		...
		value: function render() {
			...
			var autocomplete = _react2.default.createElement(_hireFormsAutocomplete2.default, _extends({}, this.props, {
			...
			var list = _react2.default.createElement(_hireFormsList2.default, _extends({}, this.props, {
				mutable: true,
...
},{"hire-forms-autocomplete":1,"hire-forms-list":4,"hire-forms-prop-types":2,"react":"react"}],4:[function(_dereq_,module,exports){
"use strict";
			...
			var List = function (_React$Component) {
				...
				_createClass(List, [{
					...
					value: function render() {
						...
						list = list.length ? this.props.ordered ? _react2.default.createElement('ol', null, list) : _react2.default.createElement('ul', null, list) : _react2.default.createElement('span', { className: 'hire-empty-list' }, this.props.emptyMessage);
